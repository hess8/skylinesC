/**
* @pollyjs/persister-local-storage v2.6.3
*
...
(function (global, factory) {
            ...
            (global = global || self, global['@pollyjs/persister-local-storage'] = factory());
            ...
            */
            ...
            var LocalStoragePersister =
            /*#__PURE__*/
            function (_Persister) {
              inherits(LocalStoragePersister, _Persister);

              function LocalStoragePersister() {
                classCallCheck(this, LocalStoragePersister);

                return possibleConstructorReturn(this, getPrototypeOf$2(LocalStoragePersister).apply(this, arguments));
              }

              createClass(LocalStoragePersister, [{
                key: "findRecording",
                value: function findRecording(recordingId) {
                  return this.db[recordingId] || null;
                }
              }, {
                key: "saveRecording",
                value: function saveRecording(recordingId, data) {
                  var db = this.db;
                  db[recordingId] = data;
                  this.db = db;
                }
                ...
                key: "deleteRecording",
                value: function deleteRecording(recordingId) {
                  var db = this.db;
                ...
                get: function get() {
                  ...
                  this.assert("Could not find \"localStorage\" on the given context \"".concat(context, "\"."), context && context.localStorage);
                  return context.localStorage;
                }
              }, {
                key: "db",
                get: function get() {
                  var items = this.localStorage.getItem(this.options.key);
                  return items ? parse$1(items) : {};
                },
                set: function set(db) {
...
//# sourceMappingURL=pollyjs-persister-local-storage.js.map
