...
(function (global, factory) {
	...
	(global = global || self, global['@pollyjs/persister-rest'] = factory());
	...
	function () {
	  ...
	  createClass(Log, [{
	    ...
	    value: function addEntries() {
	      ...
	      [].concat(toConsumableArray(entries), toConsumableArray(this.entries)), function (a, b) {
	...
	*/
	...
	function toNVPairs(o) {
	  return keys$2(o || {}).reduce(function (pairs, name) {
	    ...
	    if (isArray$5(value)) {
	      ...
	      //     => { 'content-type': ['text/htm'] }
	      pairs.push.apply(pairs, toConsumableArray(value.map(function (v) {
	        return {
	          name: name,
	          value: v,
	          _fromType: 'array'
	...
	var keys$4 = keys$1;
	var REQUEST_ASYNC = !('navigator' in global$1) || !/PhantomJS/.test(global$1.navigator.userAgent);
	var NativeXMLHttpRequest = global$1.XMLHttpRequest;
	function ajax(url) {
	  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	  return new promise$1(function (resolve, reject) {
	    var xhr = new NativeXMLHttpRequest();
	    xhr.open(options.method || 'GET', url, REQUEST_ASYNC);
	    keys$4(options.headers || {}).forEach(function (k) {
	...
	function handleResponse(xhr, resolve, reject) {
	  ...
	  return xhr.status >= 200 && xhr.status < 300 ? resolve({
	    body: body,
	    xhr: xhr
	  }) : reject(xhr);
	}
	...
	/*#__PURE__*/
	function (_Persister) {
	  inherits(RestPersister, _Persister);

	  function RestPersister() {
	    classCallCheck(this, RestPersister);

	    return possibleConstructorReturn(this, getPrototypeOf$2(RestPersister).apply(this, arguments));
	  }

	  createClass(RestPersister, [{
	    key: "ajax",
	    value: function ajax$1(url) {
	      var _this$options = this.options,
	          host = _this$options.host,
	          apiNamespace = _this$options.apiNamespace;

	      for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
	        args[_key - 1] = arguments[_key];
	      }

	      return ajax.apply(void 0, [buildUrl(host, apiNamespace, url)].concat(args));
	    }
	  }, {
	    key: "findRecording",
	    value: function () {
	      var _findRecording = asyncToGenerator(
	      /*#__PURE__*/
	      regenerator.mark(function _callee(recordingId) {
	        var response;
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                _context.next = 2;
	                return this.ajax("/".concat(encodeURIComponent(recordingId)), {
	                  Accept: 'application/json; charset=utf-8'
	                });

	              case 2:
	                response = _context.sent;
	                return _context.abrupt("return", this._normalize(response));
	      ...
	      return function findRecording(_x) {
	    ...
	    key: "saveRecording",
	    value: function () {
	      var _saveRecording = asyncToGenerator(
	      /*#__PURE__*/
	      regenerator.mark(function _callee2(recordingId, data) {
	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	      ...
	      return function saveRecording(_x2, _x3) {
	    ...
	    key: "deleteRecording",
	    value: function () {
	      var _deleteRecording = asyncToGenerator(
	      /*#__PURE__*/
	      regenerator.mark(function _callee3(recordingId) {
	        return regenerator.wrap(function _callee3$(_context3) {
	          while (1) {
	      ...
	      return function deleteRecording(_x4) {
	        return _deleteRecording.apply(this, arguments);
	      };
	    }()
	  }, {
	    key: "_normalize",
	    value: function _normalize(_ref) {
	      var xhr = _ref.xhr,
	          body = _ref.body;
...
//# sourceMappingURL=pollyjs-persister-rest.js.map
