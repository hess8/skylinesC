...
function ajax(url, options = {}) {
  return new promise$1((resolve, reject) => {
    ...
    keys(options.headers || {}).forEach(k => xhr.setRequestHeader(k, options.headers[k]));
...
class RestPersister extends Persister {
  ...
  ajax(url, ...args) {
    ...
    return ajax(utils.buildUrl(host, apiNamespace, url), ...args);
  }
