...
module.exports = function(environment) {
  let ENV = {
    ...
    SKYLINES_TILE_BASEURL: 'https://skylinescondor.com/mapproxy',
    CESIUM_TOKEN:
  ...
  if (environment === 'production') {
    ...
    ENV.MAPBOX_TILE_URL =  'https://a.tiles.mapbox.com/v4/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoic2t5bGluZXMiLCJhIjoiODR5cnAtcyJ9.OxutJHpnCaw6QQpxfl5ROA';
