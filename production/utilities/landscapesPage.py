...
lines.append('  <p> {{t "install"}} <a href="https://www.fosshub.com/qBittorrent.html">  {{"qBittorrent"}}</a> {{t "landscapesPage.qbittorent"}} <b> {{t "landscapesPage.before"}} </b> {{t "landscapesPage.magnet"}} </p> \n')
